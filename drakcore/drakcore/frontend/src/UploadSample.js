...
class UploadSample extends Component {
  ...
  formValid() {
    ...
    if (
      !fname.match(
        /^((?![\\/><|:&])[\x20-\xfe])+\.(?:dll|exe|ps1|bat|doc|docm|docx|dotm|xls|xlsx|xlsm|xltx|xltm|ppt|pttx|vbs|js|jse|hta|html|htm)$/i
      )
    ) {
      errMsg =
        "File name should not contain special characters and should have one of following extensions: dll, exe, ps1, bat, doc, docm, docx, dotm, xls, xlsx, xlsm, xltx, xltm, ppt, pttx, vbs, js, jse, hta, html, htm";
    }
