...
from drakrun.machinery.networking import setup_vm_network, start_dnsmasq
from drakrun.machinery.service import stop_all_drakruns
from drakrun.machinery.storage import REGISTERED_BACKEND_NAMES, get_storage_backend
from drakrun.machinery.vm import VirtualMachine, generate_vm_conf
from drakrun.paths import VM_CONFIG_DIR, VOLUME_DIR
...
def install(
    ...
    net_enable = config["drakrun"].getboolean("net_enable", fallback=False)
